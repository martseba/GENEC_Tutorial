#+TITLE: GENEC Pre-Supernovae
#+AUTHOR: Sébastien Martinet
...
* Part 0: Introduction
This guide was written as part of the implementation of the Timmes Equation of
State taking into account pair creation into ~eos.f90~ GENEC module.
